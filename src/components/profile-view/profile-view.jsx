...
export default class ProfileView extends React.Component {
  ...
  onRemoveFavorite = (movie) => {
    ...
    axios
      .delete(
        `https://electriccinema.herokuapp.com/users/${username}/movies/${movie}`,
  ...
  getUser = (token) => {
    const Username = localStorage.getItem("user");
    axios
      .get(`https://electriccinema.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        this.setState({
  ...
  editUser = (e) => {
    ...
    axios
      .put(
        `https://electriccinema.herokuapp.com/users/${Username}`,
        {
  ...
  onDeleteUser() {
    ...
    axios
      .delete(`https://electriccinema.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
